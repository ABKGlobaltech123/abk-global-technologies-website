      ...
      <section id="partners" className="py-20 bg-neutral-100">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center justify-items-center">
            {['Cisco', 'Dell EMC', 'HP', 'IBM', 'Microsoft', 'Palo Alto'].map((partner, index) => (
              <div 
                key={partner} 
                className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-all duration-300 hover:scale-105 scale-in"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
